...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Следующая",sPrevious:"Предыдущая"},sEmptyTable:"Данные в таблице отсутствуют",sInfo:"Показано с _START_ по _END_ из _TOTAL_ записей",sInfoEmpty:"Показано с 0 по 0 из 0 записей",sInfoFiltered:"(отфильтровано из _MAX_ записей)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показывать _MENU_ записей",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Данные в таблице отсутствуют"},
