...
<page:template>
    ...
    <jsp:attribute name="title">Изменить контакт</jsp:attribute>
    ...
    <jsp:body>
        ...
        <div class="container">
            ...
            <div class="starter-template">
                ...
                <form:form method="POST" modelAttribute="editContactForm" action="/contact_update" class="form-signin">
                    <h2 class="form-signin-heading">Изменить контакт</h2>
